/****************************************************************************/
/* file nanme  isp_contact_insert.c                                         */
/*                                                                          */
...
extern int      Proc_ISP_CONTACT_Insert( ISP_CONTACT* );


/****************************************************************************/
/* Name : isp_contact_insert                                                */
/*                                                                          */
...
/* Modify :                                                                 */
/****************************************************************************/
int isp_contact_insert(char *src_data) {
...
fflush( stdout );
		...
		resp = Proc_ISP_CONTACT_Insert(&isp_contact);
	}
	else
	{
		resp = -1;
