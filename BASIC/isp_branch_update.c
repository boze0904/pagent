/****************************************************************************/
/* file nanme  isp_branch_update.c                                          */
/*                                                                          */
...
extern int      Proc_ISP_BRANCH_Update( ISP_BRANCH* );


/****************************************************************************/
/* Name : isp_branch_update                                                 */
/*                                                                          */
...
/* Modify :                                                                 */
/****************************************************************************/
int isp_branch_update(char *src_data) {
...
fflush( stdout );
		...
		resp = Proc_ISP_BRANCH_Update(&isp_branch);
	}
	else
	{
		resp = -1;
