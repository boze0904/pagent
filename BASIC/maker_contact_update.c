/****************************************************************************/
/* file nanme  maker_contact_update.c                                       */
/*                                                                          */
...
extern int      Proc_MAKER_CONTACT_Update( MAKER_CONTACT* );


/****************************************************************************/
/* Name : maker_contact_update                                              */
/*                                                                          */
...
/* Modify :                                                                 */
/****************************************************************************/
int maker_contact_update(char *src_data) {
...
fflush( stdout );
		...
		resp = Proc_MAKER_CONTACT_Update(&maker_contact);
	}
	else
	{
		resp = -1;
